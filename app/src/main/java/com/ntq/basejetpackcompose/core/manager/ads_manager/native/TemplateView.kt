...
class TemplateView : FrameLayout {
    ...
    private fun applyStyles() {
        ...
        if (styles!!.getCallToActionTypefaceColor() != null && callToActionView != null) {
            styles!!.getCallToActionTypefaceColor()?.let { callToActionView!!.setTextColor(it) }
        }
    ...
    val templateTypeName: String
        get() {
            if (templateType == R.layout.medium_native_ad) {
                return MEDIUM_TEMPLATE
            } else if (templateType == R.layout.small_native_ad) {
    ...
    private fun initView(context: Context, attributeSet: AttributeSet?) {
        ...
        templateType = try {
            attributes.getResourceId(
                R.styleable.TemplateView_gnt_template_type, R.layout.medium_native_ad
            )
        } finally {
            attributes.recycle()
        }
